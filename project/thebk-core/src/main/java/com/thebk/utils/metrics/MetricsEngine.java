...
public final class MetricsEngine {
	public static final String METRICS_PATH = Config.getString("MetricsEngine.snapshotPath", "metrics");
	...
	public synchronized static MinMaxAvgValueMetric newMinMaxAvgValueMetrics(String name) {
	...
	public synchronized static RCFuture<Void> stopTimedSnapshot() {
		...
		return m_snapshotStopFuture.retain();
	}

	private synchronized static void indicateTimedSnapshotStop() {
		m_snapshotStopFuture.setSuccess(null).release();
		m_snapshotStopFuture = null;
	}
 ...
 */
	...
	private static final class SnapshotFileWriter extends Thread implements ISnapshotConsumer {
		...
		private ByteBuf m_outputBuf = DefaultSystems.allocator().buffer();
