...
public class RCInteger extends AbstractReferenceCounted {
	...
	RCInteger(Recycler.Handle<RCInteger> handle) {
		m_handle = handle;
	}
	...
	RCInteger initStatic(int value) {
		m_value = value;
		return this;
	}
	...
	public static RCInteger createStatic(int value) {
		return new StaticRCInteger().initStatic(value);
	}
