...
public class HttpClient {
	...
	private static final Integer Config_MaxConnections = Config.getInt(Application.CONFIG_FW_PREFIX + "http.HttpClient.maxConnections", null);
	private static final Integer Config_MaxConnectionsPerHost = Config.getInt(Application.CONFIG_FW_PREFIX + "http.HttpClient.maxConnectionsPerHost", null);
	private static final Boolean Config_KeepAlive = Config.getBoolean(Application.CONFIG_FW_PREFIX + "http.HttpClient.keepAlive", null);
