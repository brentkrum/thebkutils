...
public class Pipe {
	...
	public Pipe(IExceptionHandler exceptionHandler) {
		this(16, 4096, exceptionHandler);
	}

	public Pipe(int commandQueueMaxNumEntries, int pipeQueueMaxNumEntries, IExceptionHandler exceptionHandler) {
	...
	public <H, I> RCFuture<H> sendToProcessor(int msg, I iface) {
