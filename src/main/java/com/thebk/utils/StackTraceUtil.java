...
public class StackTraceUtil {
	public static String stackTraceToString(Throwable t) {
		...
		stackTraceFormat(writer, t);
		return writer.toString();
	}
	public static void stackTraceFormat(StringBuilder writer, Throwable t) {

		writer.append(t.getClass().getName()).append(": ");
		if (t.getMessage() != null) {
			writer.append(t.getMessage());
		}
		writer.append('\n');

		stackTraceFormat(writer, t.getStackTrace());
		
		if (t.getCause() != null) {
			writer.append("Caused by ");
			stackTraceFormat(writer, t.getCause());
		}
	}
	public static void stackTraceFormat(StringBuilder writer, StackTraceElement[] stack) {
